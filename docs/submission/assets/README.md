...
Use this as a project thumbnail or opening title card. It is original vector artwork with no third-party photos, customer data or voice recording. It is not a screenshot of the running application and must not replace the actual demonstration footage.
